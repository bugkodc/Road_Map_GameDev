...
┌─────────────────┐             ┌─────────────────┐             ┌─────────────────┐
│    Built-in     │             │       URP       │             │      HDRP       │
│(Legacy Pipeline)│             │(Universal Render│             │ (High Definition│
│                 │             │    Pipeline)    │             │ Render Pipeline)│
└────────┬────────┘             └────────┬────────┘             └────────┬────────┘
         │                               │                               │
         v                               v                               v
  Đơn giản, cũ kỹ.                Đa nền tảng nhẹ.               Đồ họa siêu thực.
  Không khuyên dùng              Tối ưu cho Mobile,             Ray-tracing, PC &
  cho dự án mới.                  PC, WebGL, Console.            High-end Console.
```
...
```
[Assets/Player.png]  <─── Cửa ngõ kết nối ───>  [Assets/Player.png.meta]
 (File ảnh thực tế)                              (Chứa mã GUID định danh duy nhất)
```
